...
function TotemPlates:UpdateFrameOnce()
    for k,nameplate in pairs(self.activeTotemNameplates) do
        ...
        nameplate.gladdyTotemFrame.totemName:SetFont(Gladdy:SMFetch("font", Gladdy.db.npTremorFont, "npTremorFont"), Gladdy.db.npTremorFontSize, "OUTLINE")
    ...
    for _,gladdyTotemFrame in ipairs(self.totemPlateCache) do
        ...
        gladdyTotemFrame.totemName:SetFont(Gladdy:SMFetch("font", Gladdy.db.npTremorFont, "npTremorFont"), Gladdy.db.npTremorFontSize, "OUTLINE")
